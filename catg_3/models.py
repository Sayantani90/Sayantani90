...
class  Jrnl_pub(models.Model):
    ...
    imp_fac             	 = models.DecimalField(verbose_name='Impact Factor (put 0 if NA)',max_digits=5,decimal_places=2,default=0.00)
...
#--------IIIB-Publications other than journal articles ---------
