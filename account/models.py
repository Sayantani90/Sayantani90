...
class Academic(models.Model):
    ...
    degree  				 = models.CharField(verbose_name='Degree/Certificate',max_length=200, null=True, blank=True)
...
class PriorPost(models.Model):
    ...
    agp                      = models.IntegerField(verbose_name='AGP/Payband', null=True, blank=True)
