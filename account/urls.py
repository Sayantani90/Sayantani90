...
urlpatterns = [
    ...
    path('teach-edit/<str:pk>/', teach_edit, name="teach-edit"),
    path('teach-edit1/<str:pk>/', teach_edit1, name="teach-edit1"),
    path('teach-delete/<str:pk>/', teach_delete, name="teach-delete"),
